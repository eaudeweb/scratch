...
class Command(BaseCommand, BaseParamsUI):
    ...
    def handle(self, *args, **options):
        self.stdout.write(self.style.SUCCESS("Importing new TED tenders..."))
        try:
        ...
        try:
            ...
            self.stdout.write(self.style.ERROR(f"TED tenders update failed: {error}"))
